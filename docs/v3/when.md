...
3. Configure a behavior to trigger on the [`Stub`][decoy.next.Stub]
...
For complex situations, you may find that you want your stub to trigger a function when called. For this, use [`Stub.then_do`][decoy.next.Stub.then_do].
